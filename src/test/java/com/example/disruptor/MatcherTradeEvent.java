...
public final class MatcherTradeEvent {
  ...
  // actual price of the deal (from maker order), 0 for rejection (price can be take from original
  // order)
  public long price;
  ...
  public boolean equals(Object o) {
    ...
    return section == other.section
        ...
        && ((nextEvent == null && other.nextEvent == null)
            || (nextEvent != null && nextEvent.equals(other.nextEvent)));
  }
